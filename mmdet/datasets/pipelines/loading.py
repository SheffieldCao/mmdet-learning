...
@PIPELINES.register_module()
class LoadDVISAnnotations:
    """Load multiple types of annotations including depth.
    ...
    Args:
        ...
        with_seg (bool): Whether to parse and load the semantic segmentation
            annotation. Default: False.
        with_depth (bool): Whether to parse and load the depth annotation.
            Default: False.
        poly2mask (bool): Whether to convert the instance masks from polygons
            to bitmaps. Default: True.
        denorm_bbox (bool): Whether to convert bbox from relative value to
    ...
    def _load_depth(self, results):
        """Private function to load depth annotations.
        ...
        results['gt_depth'] = mmcv.imfrombytes(
            img_bytes, flag='unchanged').squeeze() / 256.0
