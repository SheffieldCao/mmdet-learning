...
class CityscapesDVISDataset(CocoDataset):
    ...
    def pre_pipeline(self, results):
        ...
        results['depth_prefix'] = self.seg_prefix
    ...
    def _evaluate_depth(self, results, outfile_prefix, logger):
        """Evaluation in DVPS protocol.
