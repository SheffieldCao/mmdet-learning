...
class DVISSingleDepth(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(DVISSingleDepth, self).__init__(init_cfg)
        if pretrained:
        ...
        if depth_head is not None:
            depth_head_ = depth_head.copy()
            self.depth_head = build_head(depth_head_)
    ...
    def simple_test(self, img, img_metas, proposals=None, rescale=False):
        ...
        return_dict = dict(ins_results=None)
        ...
        if self.with_depth_head:
            ...
            return_dict.update(dict(batch_size=len(depth_results)))
