...
# model series URL: <https://github.com/open-mmlab/mmdetection/tree/master/configs/gn%2Bws>_.
...
# resume
resume_from = '~/mmdet/outputs/mask_rcnn_x50_32x4d_dw_gn_cs_8x2_cs_1024/epoch_2.pth'